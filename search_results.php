...
session_start();
/*Disable Form Resubmission on Back Click*/
header("Cache-Control: no cache");
session_cache_limiter("private_no_expire");
/* ##### End Disable Form Resubmission on Back Click ###### */
?>
<!DOCTYPE html>
<html>
<head>
...
<?php
/* If  search button is clicked from the index page */
if (isset($_POST['search'])) {
	...
	echo '</h5>';
	/* Select all attributes from lawyer table for matching with search input */
...
/* While loop for display all the available lawyers found in database*/
...
?>
	...
	<!--  End designing lawyers apperance view UI -->
	<br/>	 
<?php } ?>
<!-- End while -->
