...
<html lang="en">
<head>
	<title>Lawyer reset account</title>
	<!-- Load Icon -->
	...
	<div class="row h-75 justify-content-center align-items-center">
				...
				<br/><br/>
					...
					<div class="form-group">
						<input class="form-control" type="text" name="currentEmail" placeholder="Enter account Email" style="width: 330px;">
					</div>
					
					<div class="form-group">
						<input class="form-control" type="password" name="newPassword" placeholder="Enter Password" style="width: 330px;">	
					</div>
					<div class="form-group">
						<input class="form-control" type="password" name="conPassword" placeholder="Confirm Password" style="width: 330px;">	
					</div>
		...
		// getting users
		$query = "SELECT * FROM Lawyer WHERE email = '$user' ";
		...
		$result = mysqli_fetch_array($execute);
			 if ($result['email'] != $user) {
		    	...
		    	$update = "UPDATE Lawyer SET password = '$conPassword'
		    	WHERE email = '$user' ";
...
?>
					...
					<div class="form-group">
						<button class="btn btn-primary" name="reset" style="width: 330px;padding: 10px;">
							RESET
						</button>
					</div>
					<div class="form-group">
