...
<?php
	// creating submission query
		$query = "SELECT firstname,lastname,email,region FROM Customer WHERE customer_id = $userid";
...
?>
		...
		<h6>*** By writing and submitting this Evaluation form. You agree and approve that "This information was kindly written by you as our customer.  ***</h6>
			<div class="form-group">
				...
				<input type="text" class="form-control" readonly="" placeholder="<?php echo $result['firstname']?> <?php echo $result['lastname']?>">
			</div>
			
			<div class="form-group">
				<label for="email"> Customer E-mail</label>
				<input type="email" class="form-control" readonly="" placeholder="<?php echo $result['email']?>">
			</div>
			<div class="form-group">
				<label for="mobile"> Customer Address </label>
				<input type="text" class="form-control" readonly="" placeholder="<?php echo $result['region']?>">
			</div>
			<!-- Question Evaluation -->
