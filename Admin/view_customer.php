...
<title>Dlmp Manage Customers</title>
...
<!-- End Header with Image -->
  ...
  <hr/>
  		<h2 class="text-info text-center">Manage All In Simple Easy Steps</h2>
                        ...
                        <h4 class="text text-info">Dlmp Registered Customers</h4>
  <p>Manage all your Registered Customers at Once .</p>  
      ...
      <tr>
       ...
       <?php
            if (isset($_POST['delete'])) {
              $customerId = $_POST['customerCurrent'];
              // Query
        ...
        <input type="hidden" name="customerCurrent" value="<?php echo $display['customer_id']; ?>">
        <!-- End Get customer Id -->
       ...
       <?php 
       $total = "SELECT COUNT(*) FROM Customer";
