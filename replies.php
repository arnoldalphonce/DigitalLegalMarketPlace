...
?>
         <div class="card card-body bg-light">
              <!-- Replies Begins here -->
              <h6 class="text-info" style="text-transform: capitalize;"><img src="users/user-secret.png" style="width: 50px;height: 50px;border-radius: 50%;">  &nbsp Annonymous <i class="fas fa-check-square" style="color: #240091;"></i></h6>
